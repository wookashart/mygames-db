...
CREATE TABLE `windows` (
  `windows_id` int(255) NOT NULL,
  `windows_name` varchar(255) COLLATE utf8_polish_ci NOT NULL
...
ALTER TABLE `windows`
  ...
  ADD UNIQUE KEY `windows_name` (`windows_name`);
...
--
ALTER TABLE `windows`
  MODIFY `windows_id` int(255) NOT NULL AUTO_INCREMENT;
COMMIT;
