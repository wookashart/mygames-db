...
const ProducerDelete = ({ editItem, open, handleClose, handleReloadData }: ProducerDeleteProps) => {
      ...
      <form onSubmit={formik.handleSubmit}>
        <Box mt={2}>
          <Typography color={customColors.textLight}>
            Czy na pewno chcesz usunąć producenta: <strong>{editItem?.producer_name}</strong>?
          </Typography>
        </Box>
